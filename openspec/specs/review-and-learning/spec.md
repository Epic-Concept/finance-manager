# review-and-learning Specification

## Purpose

The human review surface (list/resolve review items) and the confirmation → learner → rule-promotion loop that improves coverage over time.
