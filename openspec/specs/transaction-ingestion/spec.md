...
Incremental nightly pull-sync of transactions from the upstream Azure SQL into the gb10 store — cursor/checkpointing, idempotent upsert, normalization to the canonical model, and scheduling.
